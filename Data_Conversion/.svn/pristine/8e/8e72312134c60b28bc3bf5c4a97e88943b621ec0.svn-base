...
<div>
    <table id = fixedColumns>
	    <tr>
		    ...
		    <td><select id="field" class="form-control Column">
		    		<option value="">--Please Select--</option>
		    	</select></td> 
		    <td><label class="control-label">Country :</label></td>
		    <td><select id="countryForCopyRul" class="form-control">
	    		 	  <option value="">--Please Select--</option>
	    		</select></td> 
	    	<td><label class="control-label">State :</label></td>
  			<td><select id="stateForCopyRul" class="form-control">
	    		 	  <option value="">--Please Select--</option>
	    		</select></td>
	    	<td><label class="control-label">County :</label></td>
  			<td><select id="countyForCopyRul" class="form-control">
	    		 	  <option value="">--Please Select--</option>
	    		</select></td>
	    	<td><label class="control-label">Edition :</label></td>
  			<td><select id="editionForCopyRul" class="form-control">
	    		 	  <option value="">--Please Select--</option>
