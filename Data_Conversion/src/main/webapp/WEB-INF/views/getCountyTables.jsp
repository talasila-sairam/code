...
<<<<<<< .mine
        ...
        $("#saveFieldDataBtn").click(function(){
        	...
        	if(fieldNumber==18||fieldNumber==19||fieldNumber==22){
    			fieldNumber18To22Validation(fieldNumber,countyName,edition,countryFipsCode,stateFipsCode,countyFipsCode,stateName,countryName);
    		}
    			...
    			fieldNumber171To175Validation(fieldNumber,countyName,editonNumber,countryFipsCode,stateFipsCode,countyFipsCode,stateName,countryName);
    		}
    		else{
        					    ...
        					    buttons: {
        					            Ok: function() {
        					        		...
        					        		var jsonData = {
        						    				...
        						    				"mappingFieldName":mappingFieldName,
        						    				"edition":edition,
        						    				"selectedFieldName":fieldAliasName,
        						    				"selectedFieldNumber":dependentFieldNumber,
        						    				"selectedFieldValue":ruleLevelNumber
        				    					}
        					        		$.ajax({
        					    		    	type: "POST",
        					    		    	url: 'saveFieldData',
        	...
        	function fieldNumber171To175Validation(fieldNumber,countyName,editonNumber,countryFipsCode,stateFipsCode,countyFipsCode,stateName,countryName){
        		var jspToLoad="";	
        		var fieldAliasName = "";
